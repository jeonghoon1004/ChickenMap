...
public class ApiRequest {
    ...
    private static String gps(LatLng latLng){
        ...
        //String position = "126.9783881,37.5666102";
        ...
        try {
            ...
            String str = area1.getString("name") +" "+ area2.getString("name");
            return str;
